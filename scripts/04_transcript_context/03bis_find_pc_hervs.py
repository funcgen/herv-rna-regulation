...
PC_TSV = "../../../results/lncRNA/protein_coding_overlapping_HERVs.gene_level.tsv"
OUT_TSV = "../../../results/lncRNA/protein_coding_overlapping_herv_coverage.tsv"
